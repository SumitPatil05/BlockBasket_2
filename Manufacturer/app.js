...
async function addManufacturingRecord() {
  try {
    ...
    const manufacturingBatchNumber = document.getElementById("batch_no").value;
    const processesDone = document.getElementById("processes").value;
    const allergenData = document.getElementById("allergen").value;
    const nutritionalInformation = document.getElementById("nutritional").value;
    const quantity = document.getElementById("quantity").value;
    const storageInstructions = document.getElementById(
      "additional_manufatcture"
    ).value;
    const contentsOfPack = document.getElementById("content").value;
    const date = document.getElementById("date_packaging").value;
    const time = document.getElementById("time_packaging").value;
    const location = document.getElementById("location_manufacturer").value;

    // Log contract information for debugging
    console.log("Contract Address:", supplyChainContract.options.address);
    console.log("Contract ABI:", supplyChainContract.options.jsonInterface);
    ...
    alert("Manufacturer record added successfully!");
  } catch (error) {
    console.error("Error adding manufacturer record:", error.message);
  }
}
